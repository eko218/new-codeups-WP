    ...
    <div class="archive-campaign__inner inner common-fish">
        <div class="archive-campaign__tab category-button">
            <ul class="category-button__list">
                <li class="category-button__list-item current"><a href="<?php echo $campaign; ?>">ALL</a>
                </li>
                <?php
                        $terms = get_terms('campaign_category');
                        foreach ( $terms as $term ) {
                        echo '<li class="category-button__list-item"><a href="'.get_term_link($term).'">'.esc_html($term->name).'</a></li>';
                        }
                    ?>
            </ul>
        </div>
